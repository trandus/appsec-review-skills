...
- SQL/NoSQL injection, command injection, path traversal, SSRF, unsafe redirects, and deserialization.
- File upload: type, size, storage path, scanning, public access, and file names.
- XSS/template injection, especially when input returns to HTML, Markdown, JavaScript, or URL contexts.
...
- File upload accepts dangerous content, public paths, oversized files, or attacker-controlled names without controls.
